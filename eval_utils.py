...
def language_eval(preds, model_id, split):
    import sys
    print('******************test2')
    sys.path.append("/storage/XWF/weak_vrg_attr_state/SSVRG/coco_caption")
    annFile = '/storage/XWF/weak_vrg_attr_state/SSVRG/coco_caption/annotations/captions_val2014.json'
