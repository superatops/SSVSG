...
def parse_opt():
    ...
    parser.add_argument('--id', type=str, default='train',
                    help='an id identifying this run/job. used in cross-val and appended when writing progress files')
    parser.add_argument('--gpus', type=str, default='2', help='set CUDA_VISIBLE_DEVICES')
    # Data input settings
    parser.add_argument('--input_json', type=str, default='/storage/XWF2/WeakVRD-Captioning-master/data/cocotalk_final.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='/storage/XWF2/data/cocobu_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/storage/XWF2/data/cocobu_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_label_h5', type=str, default='/storage/XWF2/WeakVRD-Captioning-master/data/cocotalk_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--train_only', type=int, default=0,
                    help='if true then use 80k, else use 110k')
    parser.add_argument('--cached_tokens', type=str, default='/storage/XWF2/WeakVRD-Captioning-master/data/coco-train-idxs',
    ...
    parser.add_argument('--checkpoint_root', type=str, default='/storage/XWF/weak_vrg_attr_state/SSVRG/checkpoint/vrg_oar_st',
    ...
    parser.add_argument('--vrg_data_dir', type=str, default='/storage/XWF2/WeakVRD-Captioning-master/data/coco_cmb_vrg',
    ...
    #
    #'/storage/XWF/SGAE-master/data/coco_spice_sg2/'
    parser.add_argument('--vrg_data_dir_attr', type=str, default='/storage/XWF2/WeakVRD-Captioning-master/data/coco_img_sg/coco_img_sg/',
                        help='path to the scene graph data directory, containing numpy files about the '
                             'labels of object, attribute, and semantic relationships for each image')
